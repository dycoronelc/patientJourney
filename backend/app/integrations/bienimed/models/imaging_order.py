"""
Modelo de Orden de Imagenología para Bienimed
"""
from sqlalchemy import Column, Integer, String, DateTime, Text
from sqlalchemy.sql import func
from ..database import BienimedBase

class ImagingOrder(BienimedBase):
    __tablename__ = "recetas_ordenes_imagenologia"
    ...
    def __repr__(self):
        return f"<ImagingOrder(id={self.id}, diagnostico_id={self.iddiagnostico})>"
